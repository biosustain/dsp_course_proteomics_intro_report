...
file_path = (section_dir / '../../report/uniprot_annotations/1_differently_regulated_as_in_paper.csv').resolve().as_posix()
...
file_path = (section_dir / '../../report/uniprot_annotations/2_highlighted_proteins_in_figure3.csv').resolve().as_posix()
df = pd.read_csv(file_path)
...
file_path = (section_dir / '../../report/uniprot_annotations/3_highlighted_proteins_in_figure3_intensities.csv').resolve().as_posix()
df = pd.read_csv(file_path)
...
file_path = (section_dir / '../../report/uniprot_annotations/3_highlighted_proteins_in_figure3_intensities_normalized.csv').resolve().as_posix()
df = pd.read_csv(file_path)
...
file_path = (section_dir / '../../report/uniprot_annotations/annotations.csv').resolve().as_posix()
df = pd.read_csv(file_path)
...
file_path = (section_dir / '../../report/uniprot_annotations/enrichment_analysis.json').resolve().as_posix()
