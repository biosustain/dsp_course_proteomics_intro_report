...
file_path = (section_dir / '../../report/2_differential_regulation/0_volcano_plot.json').resolve().as_posix()
...
file_path = (section_dir / '../../report/2_differential_regulation/1_differential_regulation.csv').resolve().as_posix()
...
file_path = (section_dir / '../../report/2_differential_regulation/1_differently_regulated_as_in_paper.csv').resolve().as_posix()
df = pd.read_csv(file_path)
...
file_path = (section_dir / '../../report/2_differential_regulation/2_highlighted_proteins_in_figure3.csv').resolve().as_posix()
df = pd.read_csv(file_path)
...
plot_file_path = (section_dir / '../../report/2_differential_regulation/data_completeness_per_group_median.png').resolve().as_posix()
